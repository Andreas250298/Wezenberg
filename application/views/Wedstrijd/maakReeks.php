...
if (isset($reeks)) {
    ...
    $dataInputBeginDatum = array('class' => 'form-control mr-sm-2', 'value' => $reeks->tijdstip,'type' => 'text', 'name' => 'tijdstip', 'id' => 'tijdstip','size' => '30', 'data-toggle' => 'tooltip', 'title' => 'Vul hier het tijdstip in van de reeks.');
